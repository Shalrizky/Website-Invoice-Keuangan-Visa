...
<div class="container-fluid ">
            ...
            <div class="col mr-2">
               <div class=" text-primary mb-1">
                  <div class="d-flex align-items-center ">
                     ...
                     <h5 class="h3 mb-0  " style="display: inline-block; margin-bottom: 0;">Edit Invoices</h5>
                  </div>
               </div>
            </div>
            <div class="col-auto">
   ...
   <form action="/invoice/update/<?= $invoiceData->id_invoice ?>" class="invoiceUpdateForm" method="post">
      <?= csrf_field() ?>
      <input type="hidden" name="preview_data" id="preview_data_input">
      <input type="hidden" name="id_customer" id="id_customer" value="<?= $customerData->id_customer ?>">
      <input type="hidden" name="id_total_pembelian" id="id_total_pembelian" value="<?= $totalPembelianData->id_total_pembelian ?>">
               ...
               <div class="card-body">
                  <div class="row no-gutters align-items-center">
                     <div class="mr-2">
                        ...
                        <input type="text" name="no_invoice" id="no_invoice" class="form-control" placeholder="No Invoice" aria-label="noInvoice" aria-describedby="addon-wrapping" value="<?= htmlspecialchars(set_value('no_invoice'))  ? htmlspecialchars(set_value('no_invoice')) : $invoiceData->no_invoice ?>" autofocus>
               ...
               <div class="card-body">
                  <div class="row no-gutters align-items-center">
                     <div class="mr-2">
                        ...
                        <input type="date" name="updated_at" class="form-control" id="updated_at" aria-label="updated_at" aria-describedby="addon-wrapping" value="<?= htmlspecialchars(set_value('updated_at', $updated_at))  ? htmlspecialchars(set_value('updated_at', $updated_at)) : $invoiceData->updated_at ?>" readonly>
                  </div>
               ...
               <div class="card-body">
                  <div class="row no-gutters align-items-center">
                     <div class="mr-2">
                        ...
                        <input type="text" name="kasa" id="kasa" class="form-control" placeholder="Kasa" aria-label="kasa" aria-describedby="addon-wrapping" value="<?= htmlspecialchars(set_value('kasa'))  ? htmlspecialchars(set_value('kasa')) : $invoiceData->kasa ?>">
                  ...
                  <div class="row no-gutters align-items-center">
                     <div class="mr-2">
                        ...
                        <select class="custom-select" name="jenis_invoice" id="jenis_invoice">
                           ...
                           <option value="Invoice Visa" <?= set_value('jenis_invoice') == 'Invoice Visa' ? 'selected' : ($invoiceData->jenis_invoice == 'Invoice Visa' ? 'selected' : '') ?>>Invoice Visa</option>
                           <option value="Invoice KAS" <?= set_value('jenis_invoice') == 'Invoice KAS' ? 'selected' : ($invoiceData->jenis_invoice == 'Invoice KAS' ? 'selected' : '') ?>>Invoice KAS</option>
                           <option value="Invoice Gaji Karyawan" <?= set_value('jenis_invoice') == 'Invoice Gaji Karyawan' ? 'selected' : ($invoiceData->jenis_invoice == 'Invoice Gaji Karyawan' ? 'selected' : '') ?>>Invoice Gaji Karyawan</option>
                        </select>
      ...
      <div class="card shadow mb-4">
         ...
         <div class="card-body">
            ...
            <div class="input-group mb-3">
               <input type="text" name="nama_customer" id="nama_customer" class="form-control" placeholder="Customer Name" aria-label="nama_customer" aria-describedby="addon-wrapping" value="<?= htmlspecialchars(set_value('nama_customer'))  ? htmlspecialchars(set_value('nama_customer')) : $customerData->nama_customer ?>">
            ...
            <div class="input-group mb-3">
               <div class="input-group-prepend">
                  <select class="custom-select btn btn-outline-secondary" name="telepon_country">
                     <option value="+62" <?= set_value('telepon_country') == '+62' ? 'selected' : ($customerData->telepon_country == '+62' ? 'selected' : '') ?>>+62</option>
                     <option value="+60" <?= set_value('telepon_country') == '+60' ? 'selected' : ($customerData->telepon_country == '+60' ? 'selected' : '') ?>>+60</option>
                     <option value="+65" <?= set_value('telepon_country') == '+65' ? 'selected' : ($customerData->telepon_country == '+65' ? 'selected' : '') ?>>+65</option>
                     <option value="+966" <?= set_value('telepon_country') == '+966' ? 'selected' : ($customerData->telepon_country == '+966' ? 'selected' : '') ?>>+966</option>
                  </select>
               </div>

               <input type="text" name="no_telepon" id="no_telepon" class="form-control" placeholder="Phone Number" aria-label="no_telepon" aria-describedby="addon-wrapping" value="<?= htmlspecialchars(set_value('no_telepon'))  ? htmlspecialchars(set_value('no_telepon')) : $customerData->no_telepon ?>">
         ...
         <div class="card-body">
            <div class="row">
               ...
               <div class="col-md-12 justify-content-end">
                  <button id="previewButtonUpdate" class="btn btn-info" type="button"><i class="fas fa-solid fa-plus"></i> Add Purchase</button>
               </div>
            </div>
                  ...
                  <tbody>
                     <?php foreach ($pembelianData as $index => $pembelian) : ?>
                        ...
                        <tr class="tr-penjualan">
                           ...
                           <td>
                              <button class="btn btn-danger btn-sm delete-row" type="button" data-id-pembelian="<?= $pembelian->id_pembelian ?>">
      ...
      <div class="row mx-2">
         <div class="col-md-6">
            <button type="submit" class="btn btn-success" id="submitButton"><i class="fas fa-paper-plane"></i> Update</button>
